...
cat("<table>")
cat("<thead><th>colname</th><th>value</th><th>sample</th></thead>")
cat("<tbody>")

for (i in names(cudpalette:::list_cud_cols)) {
  cat(sprintf("<tr><td>%s</td><td>`#%s`</td>", 
              i, gsub("#", "", cudpalette::cud_color(i))))
  cat(sprintf("<td style='background-color:%s'>&nbsp;</td></tr>\n", cudpalette::cud_color(i)))
}
